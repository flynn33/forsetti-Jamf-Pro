...
final class TemporaryAdminElevationArchitectureTests: XCTestCase {
    ...
    private let featureFiles = [
        ...
        "JamfDashboardApp/ForsettiModules/UI/Features/SupportTechnician/ViewModels/TemporaryAdminElevationController.swift",
        "JamfDashboardApp/ForsettiModules/UI/Features/SupportTechnician/Views/Frames/TemporaryAdminElevationFrame.swift",
        "JamfDashboardApp/Framework/Networking/JamfComputerRequestScopeService.swift"
    ]

    private var repoRoot: URL {
        // <repo>/JamfDashboardAppTests/<thisFile>.swift → two parents up = <repo>.
