...
final class TemporaryAdminElevationArchitectureTests: XCTestCase {
    ...
    private let featureFiles = [
        "ForsettiJamfProApp/Modules/SupportTechnician/Models/TemporaryAdminElevationModels.swift",
        "ForsettiJamfProApp/Modules/SupportTechnician/Models/TemporaryAdminElevationSnapshotParser.swift",
        "ForsettiJamfProApp/Modules/SupportTechnician/Models/TemporaryAdminUserFacingError+Mapping.swift",
        "ForsettiJamfProApp/Modules/SupportTechnician/Services/TemporaryAdminElevationService.swift",
        "ForsettiJamfProApp/ForsettiModules/UI/Features/SupportTechnician/ViewModels/TemporaryAdminElevationController.swift",
        "ForsettiJamfProApp/ForsettiModules/UI/Features/SupportTechnician/Views/Frames/TemporaryAdminElevationFrame.swift",
        "ForsettiJamfProApp/Framework/Networking/JamfComputerRequestScopeService.swift"
    ]

    private var repoRoot: URL {
        // <repo>/ForsettiJamfProTests/<thisFile>.swift → two parents up = <repo>.
