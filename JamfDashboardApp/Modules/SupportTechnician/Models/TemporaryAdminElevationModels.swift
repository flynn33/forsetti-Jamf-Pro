...
nonisolated struct TemporaryAdminElevationConfiguration: Codable, Equatable, Sendable {
    ...
    static let disabledDefault = TemporaryAdminElevationConfiguration(
        ...
        requestScopes: [
            "5": JamfComputerRequestScope(id: "", name: "Jamf Dashboard - Temp Admin Requests - 5m", kind: "staticComputerGroup"),
            "15": JamfComputerRequestScope(id: "", name: "Jamf Dashboard - Temp Admin Requests - 15m", kind: "staticComputerGroup"),
            "30": JamfComputerRequestScope(id: "", name: "Jamf Dashboard - Temp Admin Requests - 30m", kind: "staticComputerGroup"),
            "60": JamfComputerRequestScope(id: "", name: "Jamf Dashboard - Temp Admin Requests - 60m", kind: "staticComputerGroup")
        ],
        demoteNowScope: JamfComputerRequestScope(id: "", name: "Jamf Dashboard - Temp Admin Demote Now", kind: "staticComputerGroup"),
        extensionAttributeNames: TemporaryAdminExtensionAttributeNames(
            status: "Jamf Dashboard - Temporary Admin Status",
            user: "Jamf Dashboard - Temporary Admin User",
            expiresAt: "Jamf Dashboard - Temporary Admin Expires At",
            lastChange: "Jamf Dashboard - Temporary Admin Last Change",
            runId: "Jamf Dashboard - Temporary Admin Run ID"
        )
    )
}
