...
// Typed models for the bundled Jamf Dashboard Permissions Matrix v4 resource.
//
...
// Pro privileges a Jamf Dashboard action or API endpoint requires. Jamf Pro
...
struct PermissionsMatrixDocument: Decodable {
    ...
    /// Jamf Dashboard actions/commands and their required privileges.
...
/// A single Jamf Dashboard action/command and the privileges it requires.
