...
struct DiagnosticsView: View {
    ...
    @State private var exportFilename: String = "jamf-dashboard-diagnostics"
            ...
            List {
                ...
                if let logURL = viewModel.persistentLogFileURL {
                    Section("Persistent Log") {
                        ...
                        // quits and crashes. Single self-pruning file
                        // capped at 5 MB; the oldest entries are dropped
                        // automatically to stay under the limit.
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text("Command-line access (unified log):")
                                .font(.caption2)
                                .foregroundStyle(.secondary)
                            Text("log show --subsystem com.forsetti.jamfdashboard.diagnostics --info --last 1d")
                                .font(.caption2.monospaced())
                                .textSelection(.enabled)
                        }
                    }
...
private struct DiagnosticEntryRow: View {
    ...
    private var severityColor: Color {
        ...
        case .info:    return DashboardColors.bluePrimary
