        ...
        do {
            ...
            return StoreResolution(
                ...
                startupIssue: DeploymentUserFacingIntegrationError(
                    ...
                    externalDataChanged: false,
                    safeToRetry: true,
                    recommendedAction: "Check the local database folder permissions and available disk space, then restart Jamf Dashboard. Export diagnostics if this repeats.",
...
struct DeploymentTrackerRootView: View {
    ...
    var body: some View {
        ...
        .background {
            ...
            // the module visually matches the rest of Jamf Dashboard while still
