...
enum JamfDashboardModuleIDs {
    static let diagnostics = "com.forsetti.jamfdashboard.service.diagnostics"
    static let jamf = "com.forsetti.jamfdashboard.service.jamf"
    static let scanner = "com.forsetti.jamfdashboard.service.scanner"
    static let computerSearch = "com.forsetti.jamfdashboard.feature.computer-search"
    static let mobileDeviceSearch = "com.forsetti.jamfdashboard.feature.mobile-device-search"
    static let supportTechnician = "com.forsetti.jamfdashboard.feature.support-technician"
    static let prestageDirector = "com.forsetti.jamfdashboard.feature.prestage-director"
    static let reports = "com.forsetti.jamfdashboard.feature.reports"
    static let deploymentTracker = "com.forsetti.jamfdashboard.feature.deployment-tracker"
    static let permissionsMatrix = "com.forsetti.jamfdashboard.feature.permissions-matrix"
    static let ui = "com.forsetti.jamfdashboard.ui"
    ...
    static func definition(moduleID: String) -> JamfDashboardModuleDefinition {
        guard let definition = allDefinitions.first(where: { $0.moduleID == moduleID }) else {
            preconditionFailure("Unknown Jamf Dashboard Forsetti module ID: \(moduleID)")
        }
        return definition
    }
...
struct JamfDashboardModuleDefinition: Sendable {
    ...
    private static let moduleVersion = SemVer(major: 3, minor: 32, patch: 1)
}
