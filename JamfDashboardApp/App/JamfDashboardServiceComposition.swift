...
enum JamfDashboardServiceComposition {
    static func makeForsettiServiceContainer(appServices: JamfDashboardAppServices) -> ForsettiServiceContainer {
        ...
        container.register(
            ...
            service: KeychainSecureStorageService(service: "com.forsetti.jamfdashboard")
        )
