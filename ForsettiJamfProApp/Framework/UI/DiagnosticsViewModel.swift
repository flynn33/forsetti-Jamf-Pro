...
final class DiagnosticsViewModel: ObservableObject {
    ...
    func clearLog() async {
        ...
        statusMessage = "Diagnostics cleared: in-memory buffer emptied and on-disk log deleted. Unified-log entries (visible via `log show --subsystem com.forsetti.jamfpro.diagnostics`) are unaffected."
        errorMessage = nil
        await refresh()
    }
}
