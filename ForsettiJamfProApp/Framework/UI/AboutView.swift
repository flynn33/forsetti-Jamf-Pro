...
/// A read-only informational view that describes the Forsetti Jamf Pro application,
/// its purpose, and step-by-step usage instructions. Displayed from the Settings
/// screen when the user taps "About Forsetti Jamf Pro".
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: DashboardTheme.Spacing.section) {
                HStack(spacing: DashboardTheme.Spacing.item) {
                    ...
                    Text("Forsetti Jamf Pro")
                        .font(.system(.title2, design: .rounded).weight(.bold))
                }
                .accessibilityElement(children: .combine)
                .accessibilityLabel("Forsetti Jamf Pro")

                Text("Forsetti Jamf Pro is a modular support app for Jamf Pro technicians. The framework provides secure credentials storage, centralized Jamf API communication, a module-based dashboard, and diagnostic logging.")
