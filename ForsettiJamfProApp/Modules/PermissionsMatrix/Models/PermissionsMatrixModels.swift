...
// Typed models for the bundled Forsetti Jamf Pro Permissions Matrix v4 resource.
//
...
// Pro privileges a Forsetti Jamf Pro action or API endpoint requires. Jamf Pro
...
struct PermissionsMatrixDocument: Decodable {
    ...
    /// Forsetti Jamf Pro actions/commands and their required privileges.
...
/// A single Forsetti Jamf Pro action/command and the privileges it requires.
