...
enum PermissionsMatrixDiagnosticsPresenter {
    ...
    static func resourceNotFound(resourceName: String) -> PermissionsMatrixUserFacingError {
        PermissionsMatrixUserFacingError(
            ...
            affectedSystem: "Forsetti Jamf Pro (local app bundle)",
            endpoint: nil,
            requiredPrivileges: [],
            localDataChanged: false,
            jamfDataChanged: false,
            safeToRetry: false,
            recommendedAction: "Reinstall or rebuild Forsetti Jamf Pro so the Permissions Matrix resource is bundled, then reopen this module.",
    ...
    static func decodeFailure(resourceName: String, underlying: String) -> PermissionsMatrixUserFacingError {
        PermissionsMatrixUserFacingError(
            ...
            jamfDataChanged: false,
            safeToRetry: false,
            recommendedAction: "Rebuild Forsetti Jamf Pro with a valid Permissions Matrix resource. If this persists, file a bug with the diagnostics export attached.",
            diagnosticsSource: PermissionsMatrixDiagnostics.source,
