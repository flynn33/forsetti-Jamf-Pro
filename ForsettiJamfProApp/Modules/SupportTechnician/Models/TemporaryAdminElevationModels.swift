...
nonisolated struct TemporaryAdminElevationConfiguration: Codable, Equatable, Sendable {
    ...
    static let disabledDefault = TemporaryAdminElevationConfiguration(
        ...
        requestScopes: [
            "5": JamfComputerRequestScope(id: "", name: "Forsetti Jamf Pro - Temp Admin Requests - 5m", kind: "staticComputerGroup"),
            "15": JamfComputerRequestScope(id: "", name: "Forsetti Jamf Pro - Temp Admin Requests - 15m", kind: "staticComputerGroup"),
            "30": JamfComputerRequestScope(id: "", name: "Forsetti Jamf Pro - Temp Admin Requests - 30m", kind: "staticComputerGroup"),
            "60": JamfComputerRequestScope(id: "", name: "Forsetti Jamf Pro - Temp Admin Requests - 60m", kind: "staticComputerGroup")
        ],
        demoteNowScope: JamfComputerRequestScope(id: "", name: "Forsetti Jamf Pro - Temp Admin Demote Now", kind: "staticComputerGroup"),
        extensionAttributeNames: TemporaryAdminExtensionAttributeNames(
