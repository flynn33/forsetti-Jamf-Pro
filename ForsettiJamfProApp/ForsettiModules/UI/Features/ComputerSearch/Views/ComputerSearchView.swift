...
struct ComputerSearchView: View {
    ...
    private var computerHeaderCopy: some View {
    ...
    private var compactSearchControlRows: some View {
        VStack(alignment: .leading, spacing: DashboardTheme.Spacing.md) {
            searchProfilePicker
    ...
    private var searchProfilePicker: some View {
