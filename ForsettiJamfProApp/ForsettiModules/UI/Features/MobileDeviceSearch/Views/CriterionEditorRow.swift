...
struct CriterionEditorRow: View {
    ...
    private var field: MobileDeviceField? {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack(spacing: 8) {
                // Field picker — opens AdvancedFieldPickerView via sheet so the
                // search-and-group experience matches the existing FieldCatalog.
                Button {
