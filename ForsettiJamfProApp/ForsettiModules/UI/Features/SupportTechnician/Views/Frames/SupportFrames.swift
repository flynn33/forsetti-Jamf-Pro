...
private enum FrameLayout {
    ...
    static let drillInCardHeight: CGFloat = 132
}
...
private struct SecurityFrame: View {
    ...
    private var statusCardsGrid: some View {
        ...
        return LazyVGrid(columns: [GridItem(.adaptive(minimum: 210), spacing: 8, alignment: .top)], spacing: 8) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                if let net = networkInfo {
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        LazyVGrid(columns: [GridItem(.adaptive(minimum: 210), spacing: 8, alignment: .top)], spacing: 8) {
...
private struct DetailDrillInCard: View {
    ...
    var body: some View {
        Button(action: onOpen) {
            ...
            .padding(12)
            .frame(maxWidth: .infinity, minHeight: FrameLayout.drillInCardHeight, maxHeight: FrameLayout.drillInCardHeight, alignment: .topLeading)
            .background(DashboardTheme.groupedSurface)
            .clipShape(RoundedRectangle(cornerRadius: DashboardTheme.Radius.button))
            .overlay(
                RoundedRectangle(cornerRadius: DashboardTheme.Radius.button)
