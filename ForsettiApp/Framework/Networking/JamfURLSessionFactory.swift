...
///    operator who reports "Forsetti feels sluggish today" has
...
enum JamfURLSessionFactory {
    ...
    static func make(diagnosticsReporter: any DiagnosticsReporting) -> URLSession {
        ...
        // Allow cellular and expensive networks — Forsetti runs
...
/// reused. These land in `forsetti-telemetry.ndjson` and surface
