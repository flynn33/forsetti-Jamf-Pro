...
struct DashboardPrimaryButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        ...
        configuration.label
            ...
            .shadow(
                color: isEnabled ? DashboardTheme.shadowColor : .clear,
...
struct DashboardSecondaryButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        ...
        configuration.label
            .font(.system(.headline, design: .rounded).weight(.semibold))
            .foregroundStyle(isEnabled ? DashboardColors.bluePrimary : Color.secondary)
            .padding(.vertical, 11)
            .padding(.horizontal, 16)
            .background(
                shape
    ...
    private var borderColor: Color {
        isEnabled ? DashboardColors.bluePrimary.opacity(0.35) : DashboardPlatformColors.separator
    }
    ...
    private func backgroundColor(isPressed: Bool) -> Color {
        ...
        return isPressed ? DashboardColors.blueSecondary.opacity(0.22) : DashboardTheme.surface
    }
}
...
struct DashboardDangerButtonStyle: ButtonStyle {
    ...
    private var borderColor: Color {
        isEnabled ? Color.red.opacity(0.35) : DashboardPlatformColors.separator
    }
    ...
    private func backgroundColor(isPressed: Bool) -> Color {
        ...
        return isPressed ? Color.red.opacity(0.16) : DashboardTheme.surface
    }
}
