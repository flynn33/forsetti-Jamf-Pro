...
actor SupportTechnicianAPIService {
    ...
    func createApplicationActionScript(
        ...
        let payload: [String: Any] = [
            "name": name,
            "info": "Auto-generated by Forsetti to \(actionVerb.lowercased()) \(appName) on \(deviceDisplayName) (serial \(serialNumber)). Safe to delete after the paired one-shot policy has executed.",
